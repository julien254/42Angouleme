...
sh 42Angouleme/troncCommun2/born2beroot/install-utils.sh
sudo sh 42Angouleme/troncCommun2/born2beroot/install-security.sh
sh 42Angouleme/troncCommun2/born2beroot/install-wordpress.sh
sh 42Angouleme/troncCommun2/born2beroot/install-monitoring.sh
echo "\n\nVIM: Pour finaliser l'installation des plugins de vim, lancer celui-ci et entrer la commande :PlugInstall.(Sur le compte ROOT egalement)\n"
